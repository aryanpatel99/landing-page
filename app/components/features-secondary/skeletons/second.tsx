        ...
        style={{
         ...
         className='flex-1 rounded-t-3xl flex items-center justify-center gap-2 w-full h-full absolute inset-x-0 p-2'>
            <CircleSkeleton className="flex items-center justify-center border-neutral-200 shadow-sm">
                ...
                <RevolvingCard className="[--translate-position:160px] [--orbit-duration:19s]">
                ...
                <RevolvingCard className="[--translate-position:200px] [--orbit-duration:29s]">
                    <InstagramIcon className="size-10 text-red-500"/>
                </RevolvingCard>
                <RevolvingCard className="[--translate-position:160px] [--orbit-duration:35s]">
...
export const RevolvingCard = ({className,children}: {className?: string, children?: React.ReactNode    })=>{
    return(
       <div className={cn("absolute flex items-center justify-center bg-white border border-transparent ring-1 ring-black/10 rounded-sm animate-orbit [--translate-position:120px] [--orbit-duration:9s] ",className)}>{children}</div>
    )
}
